    ...
    <div className="max-w-2xl space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-5">
          ...
          <div className="flex flex-wrap gap-2">
            {PRESETS.map(p => (
              <button
                ...
                className={`text-xs font-medium px-3 py-1.5 border rounded-lg transition ${p.style}`}
              >
                {p.label}
              </button>
            ))}
        ...
        <button
          ...
          className="w-full bg-blue-600 text-white py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-700 active:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition"
        >
      ...
      {response && (
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-semibold text-slate-700">Respuesta del backend</h2>
            {!response.error && (
